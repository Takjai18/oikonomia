...
SAMPLE_ITEMS = [
    ...
    # —— Act 1 飛狐雪山（實體道具 + QR；無火機）——
    {
        "name": "木材",
        "description": "【Act 1】生火用木材。掃描後立刻觸發雪山熊「布布」教學戰。",
        "icon": "🪵",
        "item_type": "qr",
        ...
        "effect_type": None,
        "effect_value": 0,
        "image_path": "/static/images/default-item.svg",
    },
    {
        "name": "水",
        "description": "【Act 1】雪山上搜集到的水。掃描 QR 完成「水」任務。",
        "icon": "💧",
        "item_type": "qr",
    ...
    {
        "name": "殘缺的山羊徵章",
        "description": "【Act 1】Iggy 的個人物品——殘缺的山羊徵章。掃描 QR 完成任務。",
        "icon": "🐐",
        "item_type": "qr",
    ...
    {
        "name": "刻著 Iggy 的鐵片",
        "description": "【Act 1】鐵片上刻住「Iggy」。掃描 QR 確認重傷男子的身份。",
        "icon": "🔩",
        "item_type": "qr",
