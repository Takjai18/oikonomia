    ...
    "iggy_stage0": {
        ...
        "lines": [
            ...
            },
            {
                "character": "旁白",
                "text": (
                    "你們本想著在這個寒冬裡，能為山上有需要的野生狐狸"
                    "帶來一點溫飽與生機。然而，狐狸沒有出現——"
                    "呈現在你們眼前的，卻是一片混亂的戰鬥痕跡，"
                    "以及一個躺在雪堆中、全身滿是血痕與凍傷的年輕男子。"
                ),
            },
            {
                "character": "旁白",
                "text": (
                    "你們連忙圍上去。那名年輕男子凍得嘴唇發紫，"
                    "身上穿著破爛的衣物，呼吸微弱得幾乎感覺不到。"
                ),
            },
            {
                "character": "旁白",
                "text": (
                    ...
                    "為了幫他生火取暖，並將背包裡的醬板鴨烤熱給他充饑，"
                    "你們開始在周圍的雪地裡搜尋木材與生火工具。"
                ),
            },
            {
                "character": "旁白",
                "text": (
                    "你們找到了火機，並在冰雪中搜集木材與木筷子。"
                    "然而，就在你們撿起木筷子的那一刻，"
                    "樹林深處突然傳來一聲咆哮——"
                    "一隻名叫「布布」的雪山熊猛然撲出！"
                ),
            ...
            },
            {
                "character": "旁白",
                "text": (
                    "接下來：掃描 QR 取得火機與木材（木材會觸發布布教學戰）；"
                    "並找出他的個人物品——殘缺的山羊徵章，以及刻著「Iggy」的鐵片。"
                ),
            },
        ],
    },
