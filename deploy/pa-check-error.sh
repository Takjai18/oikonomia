...
echo ""
echo "--- Python import test (wsgi) ---"
cd "$REPO" || exit 1
export DATA_DIR="$REPO/data"
export FLASK_ENV=production
export SECRET_KEY="${SECRET_KEY:-deploy-check-placeholder}"
...
echo "3. WSGI file should contain ONLY:"
echo "   import sys"
echo "   sys.path.insert(0, '$REPO')"
echo "   from wsgi import application"
echo "4. Environment variables: SECRET_KEY (required), GM_PIN, DATA_DIR=data"
